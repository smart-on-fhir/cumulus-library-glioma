...
study_diag as (
    select  distinct
            ...
            diag.result_ref,
    	    study_population.*
	from    glioma__cohort_study_population as study_population,
	        glioma__valueset_diag_category  as valueset,
...
from        study_diag
left join   glioma__valueset_diag_category  as valueset
