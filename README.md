...
|------------------------------------|--------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| Chemotherapy + molecular           | [Cancer drugs (class)](cumulus_library_glioma/rx_ta_cancer.toml)               |                                                                                                                                                                                          |
...
| Molecular                          | [Monoclonal Antibodies (mAb)](cumulus_library_glioma/rx_class_mab.toml)        | [Bevacizumab](cumulus_library_glioma/rx_in_bevacizumab.toml)                                                                                                                             |
...
| Documentation                                                                                    | Task                                                      |  
|--------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| Cumulus [first-time-setup](https://docs.smarthealthit.org/cumulus/library/first-time-setup.html) | build `core` dependencies required by this `glioma` study |
